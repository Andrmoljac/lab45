...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\materija\Ra175-2013\LPRS2\vezbe\lab3\zad3
  logical library name                       : vga_peripheral_mem_new_v1_01_a
  top name                                   : vga_peripheral_mem_new
  version                                    : 1.01.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/vga_peripheral_mem_new.vhd
...
- XPS interface file(s)
  ...
  data/vga_peripheral_mem_new_v2_1_0.mpd
  ...
  data/vga_peripheral_mem_new_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/vga_peripheral_mem_new.xise
  ...
  devl/projnav/vga_peripheral_mem_new.tcl

    This is the TCL command line file used to generate the .xise file.

- XST synthesis file(s)

  devl/synthesis/vga_peripheral_mem_new_xst.scr
  ...
  devl/synthesis/vga_peripheral_mem_new_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/vga_peripheral_mem_new_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/vga_peripheral_mem_new_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\materija\Ra175-2013\LPRS2\vezbe\lab3\zad3\C:\Xilinx\14.6\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf
