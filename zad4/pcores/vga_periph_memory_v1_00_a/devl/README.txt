...
Peripheral Summary:
  ...
  logical library name                       : vga_periph_memory_v1_00_a
  top name                                   : vga_periph_memory
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/vga_periph_memory.vhd
...
- XPS interface file(s)
  ...
  data/vga_periph_memory_v2_1_0.mpd
  ...
  data/vga_periph_memory_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/vga_periph_memory.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/vga_periph_memory_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/vga_periph_memory_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/vga_periph_memory_v2_1_0.tcl
