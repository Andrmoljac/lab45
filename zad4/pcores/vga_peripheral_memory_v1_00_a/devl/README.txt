...
Peripheral Summary:
  ...
  logical library name                       : vga_peripheral_memory_v1_00_a
  top name                                   : vga_peripheral_memory
  version                                    : 1.00.a
  type                                       : AXI4LITE slave
...
- HDL source file(s)
  ...
  hdl/vhdl/vga_peripheral_memory.vhd
...
- XPS interface file(s)
  ...
  data/vga_peripheral_memory_v2_1_0.mpd
  ...
  data/vga_peripheral_memory_v2_1_0.pao
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/vga_peripheral_memory_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/vga_peripheral_memory_v2_1_0.tcl
